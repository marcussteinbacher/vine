...
# Temporarily set numpy to raise errors on invalid operations to catch issues early
...
def main():
    ...
    windows_indices, windows = AdjustedReturn.adjusted_return_windows(returns, volatilities, n=params.simulation.window_size)
    print("Done!")
